...
public class HomeChartDataSet extends PieDataSetImpl {

	private Date creationDate;
	private SimpleDateFormat format;
	private IPieChartConfiguration iPieChartConfiguration;
	
	public HomeChartDataSet() {
		super();
		this.format = new SimpleDateFormat("HH:mm:ss");
		this.creationDate = new Date();
	}

	public HomeChartDataSet(String sql, String attCategory, String attValues, Integer limit) throws SQLException {
		this();
