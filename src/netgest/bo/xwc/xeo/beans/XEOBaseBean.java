...
public class XEOBaseBean extends XEOBase {
    ...
    public void lookupAttribute( String sCompId ) throws boRuntimeException {
        ...
        // Verifica o modo de ediï¿½ï¿½o do Objecto... se for orfï¿½o
     ...
     * @param oEditBean
     */
    public void setOrphanEdit( XEOBaseBean oEditBean ) throws boRuntimeException {
        XUIRequestContext   oRequestContext;
        ...
        try {
            ...
            if( oEditBean.getParentComponentId() != null )
            {
                ...
                if( oSrcComp instanceof AttributeBase ) {
                    ...
                    // ï¿½ uma grid... por isso deve-se adicionar ï¿½ bridge
    ...
    public void duplicate() throws boRuntimeException {
    	...
    	((XEOBaseBean)clonedView.getBean("viewBean")).setCurrentObjectKey( 
    ...
    public void showProperties() {
        ...
        ((XEOBaseBean)oViewRoot.getBean("viewBean")).setCurrentObjectKey( Long.toString( getXEOObject().getBoui() ) );
    ...
    public XEOBaseBean getParentBean() {
    	if( this.parentBean == null )
    		return (XEOBaseBean)getParentView().getBean( getParentBeanId() );
    	else
