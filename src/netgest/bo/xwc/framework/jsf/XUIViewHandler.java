...
public class XUIViewHandler extends XUIViewHandlerImpl {
    ...
    public UIViewRoot restoreView(FacesContext context, String viewId, Object savedId ) {
        ...
        if( viewRoot != null )
        {
	        ...
	        // Se existe view restora a transacÁ£Ø associada a view.
    ...
    public UIViewRoot createView(FacesContext context, String viewId, InputStream viewerInputStream, String sTransactionId, XUIViewerDefinition viewerDefinition ) 
    {
        ...
        //Aqui verificar se est· na cache, se estiver, devolve, sen„o cria novo
        ...
        try {
	        ...
	        ///O que estiver com tab para dentro n„o È para ser feito quando j· existe uma vers„o na cache
	        ...
	        //Flag na viewRoot (cacheable ou n„o)
	        //Fixar ids? 
	        	//E TemplateIncludes? - ele faz cache?
	        	//Include de Viewer (se calhar nao faz diferenÁa porque e sempre o mesmo)
