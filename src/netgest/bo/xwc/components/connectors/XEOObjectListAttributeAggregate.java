...
public class XEOObjectListAttributeAggregate implements DataFieldConnector {

	private XEOObjectListGroupConnector parent;
	private int							row;
	
		   
	public XEOObjectListAttributeAggregate( XEOObjectListGroupConnector parent, int row,String attName ) {
		this.parent = parent;
		this.row = row;
	}
	...
	public String getDisplayValue() {
		return String.valueOf( parent.getDataSet().rows( row ).getString("aggregate") );
	}
