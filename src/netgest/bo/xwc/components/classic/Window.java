...
public class Window extends XUIComponentBase {
    ...
    public XUIStateProperty<String> width = new XUIStateProperty<String>( "width", this, "500" );
    public XUIStateProperty<String> height = new XUIStateProperty<String>( "height", this, "300" );
